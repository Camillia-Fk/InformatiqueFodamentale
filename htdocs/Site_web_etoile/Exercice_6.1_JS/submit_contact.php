...
//Définit le nom d'utilisateur pour se connecter à la base de données. (root est l'utilisateur par défaut)
$username = "root";
//Définit le mot de passe de l'utilisateur pour se connecter à la base de données.
$password = "";
//Définit le nom de la base de données à laquelle vous voulez vous connecter
$dbname = "formulaire_bd"; // Remplacez par le nom de votre base de données
...
// Vérifie si le champ 'prenom' n'est pas définie

    ...
    <body>
        ...
        <div class="container">
            ...
            <main>
                ...
                <!--Autre liste sans ordre particulier -->
                <ul>
                <!-- Un élément d'une liste qui affiche un titre "NaineRouge" suivi d'une image qui contient un titre alternatif pour l'image au cas ou l'image
                ne peut être chargé et une infobulle quand ont la survolle avec la sourie.  -->
                    <li> <span class="petittitre" id="NaineRouge"> <strong>Alpha du Centaure C ou proxima centauri </strong>  </span><br> <br> <img class="interactive" src="image/naine_rouge.jpg" alt="naine_rouge" width="300" height="200" title="Alpha du Centaure C"> </li>
                </ul>
                <ul>
                    <!-- Les éléments de la liste (caracteristique de l'étoile) -->
                    <li> <strong>Constellation :</strong> Centaure </li>
                    <li> <strong>Etat :</strong> Naine rouge</li>
                    <li> <strong>Âge :</strong>  entre 4.85 et 6.8 millards d'années. </li>
                    ...
                    <li> <strong>Disantance de la terre :</strong> 4,367 années-lumière, c'est l'étoile la plus proche du soleil</li>
                </ul>
                ...
                <!--Autre liste sans ordre particulier -->
                <ul>
                <!-- Un élément d'une liste qui affiche un titre "NaineJaune" suivi d'une image qui contient un titre alternatif pour l'image au cas ou l'image
                ne peut être chargé et une infobulle quand ont la survolle avec la sourie.  -->
                    <li> <span class="petittitre" id="NaineJaune"> <strong> Soleil </strong> </span><br> <br> <img class="interactive" src="image/naine_jaune.jpg" alt="naine_jaune" width="200" height="200" title="Le soleil"> </li>
                </ul>
                <ul>
                    <!-- Les éléments de la liste (caracteristique de l'étoile) -->
                    <li> <strong>Etat :</strong> Naine jaune</li>
                    <li> <strong>Âge :</strong> 4,5 Millards d'années </li>
                ...
                <ul>
                    ...
                    ne peut être chargé et une infobulle quand ont la survolle avec la sourie.  -->
                <li> <span class="petittitre" id="EtoileMassiveMoyenne"> <strong> Bételgeuse </strong>  </span> <br> <br> <img class="interactive" src="image/Etoile_moyenne.jpg" width="300" alt="EtoileMoyenne" title="Etoile massive moyenne">
                ...
                <ul>
                    <!-- Un élément d'une liste qui affiche un titre "EtoileGéante" suivi d'une image qui contient un titre alternatif pour l'image au cas ou l'image
                    ne peut être chargé et une infobulle quand ont la survolle avec la sourie.  -->
                <li> <span class="petittitre" id="EtoileGéante"> <strong>R136a1 </strong>   </span> <br>  <br> <img class="interactive" src="image/Etoile_geante.jpg" width="300" alt="Etoilegeante" title="Etoile massive géante">
            ...
            R136a1 est la plus massive étoile jamais observé.
                ...
                <div class="video-container">
                    <video width="320" height="240" controls>
                        <source src="image/Site_web_etoile.mp4" type=video/mp4>
                    </video>
                </div>
            </main>    
        </div>  

        ...
        <div class="container">
            ...
            <div class="container star-container">
                ...
                <div class="col-md-6 col-12 star-image">
                    ...
                    <img src="image/naine_rouge.jpg" alt="naine_rouge" class="img-fluid interactive" class="img-fluid" title="Alpha du Centaure C">
                </div>
            ...
            <div class="container star-container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12 star-image">
                        ...
                        <br><br>
                        <!-- Image de l'étoile, responsive grâce à la classe 'img-fluid' -->
                        <img src="image/naine_jaune.jpg" alt="naine_jaune"  class="img-fluid interactive" class="img-fluid" title="Le soleil" style="width: 500px; height: 500px;">
                    </div>
                <!-- Colonne pour les détails de l'étoile, occupant 100% de la largeur sur petits écrans et 50% sur les grands -->
                    <div class="col-md-6 col-12 star-details">
                        <ul class="list-unstyled">
                ...
                <div class="container star-container">
                    ...
                    <div class="col-md-6 col-12 star-image">
                        ...
                        <br> <br> 
                        <img src="image/Etoile_moyenne.jpg" class="img-fluid interactive" class="img-fluid" alt="EtoileMoyenne"  title="Etoile massive moyenne">
                    </div>
                    <div class="col-md-6 col-12 star-details">
                        <ul class="list-unstyled">
                ...
                <div class="container star-container">
                    <div class="row">
                        <div class="col-md-6 col-12 star-image">
                            ...
                            <br><br> 
                            <img src="image/Etoile_geante.jpg" class="img-fluid interactive" class="img-fluid" alt="Etoilegeante" c title="Etoile massive géante" style="width: 500px; height: 500px;">
                        </div>
                    <div class="col-md-6 col-12 star-details">
                        <ul class="list-unstyled">
